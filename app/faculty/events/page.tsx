...
import { Paper, InputText, Loader } from "@snowball-tech/fractal";
...
export default function EventsPage() {
    ...
    return (
        <div className="max-w-[1400px] w-full flex flex-col gap-4">
            <Typography variant="heading-3">Events</Typography> 
            <Paper elevation="bordered" titleVariant="heading-2" className="flex flex-col gap-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
                    {filtered.map((event) => (
                        <div key={event.id} className="flex flex-col gap-2 border-2 border-fractal-border-default rounded-s bg-white hover:shadow-brutal-1 transition-all overflow-hidden">
                            {/* Top accent bar */}
