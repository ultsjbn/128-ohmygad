    ...
    return (
        ...
        <div className="flex flex-col gap-5 flex-1 min-w-0 pb-2">
            ...
            <div className="flex flex-col gap-5">
                <GlobalSearch role="staff" placeholder="Search events, courses, surveys..." />
        ...
        <aside className="flex flex-col gap-5 xl:w-[268px] shrink-0 pb-8">
            ...
            {/* quick actions */}
            <Card variant="no-hover" className="flex flex-col justify-start p-4 gap-4 h-fit">
                <div>
                ...
                <div className="flex flex-col gap-3">
                    <Button variant="soft" className="w-full justify-start gap-3" onClick={() => setActiveModal("event")}>
                        <Calendar size={16} /> 
                        <span>New Event</span>
                    </Button>
                    <Button variant="soft" className="w-full justify-start gap-3" onClick={() => setActiveModal("survey")}>
