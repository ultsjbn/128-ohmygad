/*
Admin profile page constants

Extracted from inline constant arrays in:
app/admin/profile/page.tsx (L31-32)

Currently used by:
app/admin/profile/page.tsx (sex-at-birth select, pronouns select)
*/

// Options for "Sex at Birth" dropdown.
// Used in: app/admin/profile/page.tsx (identity tab select options)
export const SEX_OPTIONS = ["Male", "Female", "Intersex", "Prefer not to say"];

// Options for "Pronouns" dropdown.
// Used in: app/admin/profile/page.tsx (personal tab select options)
