...
Currently used by:
app/admin/page.tsx (chart data & colors)
app/admin/hooks/use-dashboard-data.ts (initial state values)
*/
...
Used in: app/admin/page.tsx (AreaChart data prop)
*/
...
Used in: app/admin/hooks/use-dashboard-data.ts
*/
