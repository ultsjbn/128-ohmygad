...
import { LayoutDashboard, Calendar, BookOpen, ClipboardList, ChevronsLeft, ChevronsRight } from "lucide-react";
          ...
          {navItems.map(({ href, label, icon: Icon, exact }) => {
            ...
            return (
              <Link
                ...
                ${active
                  ? "bg-fractal-bg-body-white border-2 border-fractal-border-default shadow-soft-sm text-fractal-text-default"
