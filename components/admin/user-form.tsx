  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload: Partial<CreateUserData> = {
        ...
        student_num, year_level, is_onboarded,
        gso_attended: gso_attended === "" ? 0 : Number(gso_attended),
      };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-6 items-start w-full">
          ...
          <Card className="flex flex-col gap-3 p-5 sm:p-6 w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full">
              ...
              <Input label="Contact Number" prefixIcon={<Phone size={15} />} placeholder="e.g. 09XX-XXX-XXXX" value={contact_num} onChange={(e) => setContactNum(e.target.value)} />
          ...
          <div className="flex flex-col gap-6 w-full">
            <Card className="flex flex-col gap-3 p-5 sm:p-6 w-full">
              ...
              <Input label="GSO Sessions Attended" type="number" placeholder="0" value={gso_attended.toString()} onChange={(e) => setGsoAttended(e.target.value)} />
