...
export default function RightPanel() {
  ...
  return (
    <aside className="flex flex-col gap-4 h-full min-h-0 w-fit">
      ...
      <Paper
        elevation="elevated"
        className="bg-fractal-decorative-purple-90 p-4 cursor-pointer hover:shadow-brutal-2 transition-all border-2 border-fractal-border-default"
      >
      ...
      <Paper
        elevation="elevated"
        className="bg-fractal-decorative-yellow-90 p-4 cursor-pointer hover:shadow-brutal-2 transition-all border-2 border-fractal-border-default"
      >
        <Typography variant="body-1-median" className="text-fractal-text-placeholder mb-1">
          Pending Surveys
        </Typography>
